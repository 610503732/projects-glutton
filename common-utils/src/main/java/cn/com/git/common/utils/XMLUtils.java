...
//     * @throws Exception
//     */
//    public static Element root(String file) throws Exception {
//        // 创建saxReader对象
...
//     * @return
//     */
//    public String obj2xml(Object obj,boolean isSub,boolean pList){
...
//        Field[] fields = superClass.getFields() ;//获取所有的字段
//
//        for(Field f:fields){
//            xml.append("<"+f.getName()+"><"+f.getName()+"/>");
//        }
//
//        return "" ;
//    }
